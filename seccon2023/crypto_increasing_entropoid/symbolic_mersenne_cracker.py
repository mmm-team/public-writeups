# modified from https://github.com/icemonster/symbolic_mersenne_cracker/blob/main/main.py
from z3 import *
...
class Untwister:
    ...
    def get_random(self):
        ...
        state = list(map(lambda x: model[x].as_long(), self.ORIG_MT))
